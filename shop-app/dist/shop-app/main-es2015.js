...
/* harmony import */ var _auth_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./auth/services/auth-guard.service */ "./src/app/auth/services/auth-guard.service.ts");
...
const routes = [
    ...
    { path: 'main', loadChildren: './main/main.module#MainModule', canActivate: [_auth_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_3__["AuthGuardService"]] },
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [], imports: [[
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_7__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].firebaseConfig),
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"],
        ...
        _components_nav_nav_component__WEBPACK_IMPORTED_MODULE_13__["NavComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"],
        _material_module__WEBPACK_IMPORTED_MODULE_6__["MaterialModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_7__["AngularFireModule"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_8__["AngularFireAuthModule"],
        _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_9__["AngularFirestoreModule"],
        // MainModule,
        _auth_auth_module__WEBPACK_IMPORTED_MODULE_11__["AuthModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"]] }); })();
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _views_login_login_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/login/login.component */ "./src/app/auth/views/login/login.component.ts");
/* harmony import */ var _views_register_register_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/register/register.component */ "./src/app/auth/views/register/register.component.ts");
...
const routes = [
    { path: 'auth/login', component: _views_login_login_component__WEBPACK_IMPORTED_MODULE_2__["LoginComponent"] },
    { path: 'auth/register', component: _views_register_register_component__WEBPACK_IMPORTED_MODULE_3__["RegisterComponent"] }
];
...
/* harmony import */ var _views_login_login_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/login/login.component */ "./src/app/auth/views/login/login.component.ts");
/* harmony import */ var _views_register_register_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/register/register.component */ "./src/app/auth/views/register/register.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AuthModule, { declarations: [_views_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"], _views_register_register_component__WEBPACK_IMPORTED_MODULE_4__["RegisterComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _auth_routing_module__WEBPACK_IMPORTED_MODULE_2__["AuthRoutingModule"],
        _material_module__WEBPACK_IMPORTED_MODULE_5__["MaterialModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"]] }); })();
...
class AuthService {
    ...
    register(user) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(this.afAuth.auth
            .createUserWithEmailAndPassword(user.email, user.password))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((u) => this.userCollection.doc(u.user.uid)
            .set(Object.assign(Object.assign({}, user), { id: u.user.uid }))
            .then(() => true)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])((err) => Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(err)));
    }
    login(email, password) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(this.afAuth.auth.signInWithEmailAndPassword(email, password))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((u) => this.userCollection.doc(u.user.uid).valueChanges()), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])('Invalid credentials or user not registered.')));
    }
    logout() {
    ...
    getUser() {
        return this.afAuth.authState
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(u => (u) ?
            this.userCollection.doc(u.uid).valueChanges() : Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null)));
    }
    authenticated() {
        return this.afAuth.authState
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(u => (u) ? true : false));
    }
    updateUserData(u) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                ...
                yield this.userCollection.doc(u.user.uid).set(newUser);
                return newUser;
            }
            catch (e) {
                throw new Error(e);
    ...
    loginWithGoogleAccount() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                ...
                let credentials = yield this.afAuth.auth.signInWithPopup(provider);
                let user = yield this.updateUserData(credentials);
                return user;
            }
            catch (e) {
                throw new Error(e);
    ...
    oldLoginGoogle() {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(this.afAuth.auth.signInWithPopup(provider))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((data) => console.log(data)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((u) => {
            const newUser = {
                firstname: u.user.displayName, lastname: '',
                address: '', city: '', state: '',
                phone: '', mobilephone: '',
...
AuthService.ɵfac = function AuthService_Factory(t) { return new (t || AuthService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_5__["AngularFirestore"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_fire_auth__WEBPACK_IMPORTED_MODULE_6__["AngularFireAuth"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AuthService, [{
    ...
    }], function () { return [{ type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_5__["AngularFirestore"] }, { type: _angular_fire_auth__WEBPACK_IMPORTED_MODULE_6__["AngularFireAuth"] }]; }, null); })();
...
function LoginComponent_mat_progress_bar_15_Template(rf, ctx) { if (rf & 1) {
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 16, vars: 5, consts: [["fxLayout", "column"], ["fxLayoutAlign", "center", "fxLayout", "row"], [3, "formGroup", "ngSubmit"], [1, "login-card", "mat-elevation-z8"], ["fxLayout", "column", 4, "ngIf"], ["fxLayout", "row", "fxLayoutAlign", "space-between center"], ["mat-button", "", "color", "warn", "type", "button", 3, "disabled", "click"], ["mat-button", "", "color", "primary", "type", "submit", 3, "disabled"], ["mode", "indeterminate", 4, "ngIf"], ["matInput", "", "formControlName", "email", "type", "email", "placeholder", "E-mail", "autocomplete", "email", "readonly", "false"], ["matInput", "", "formControlName", "password", "type", "password", "placeholder", "Password", "autocomplete", "password"], ["mode", "indeterminate"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_button_click_9_listener() { return ctx.loginGoogle(); });
...
function NavComponent_mat_toolbar_0_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NavComponent_mat_toolbar_0_Template_button_click_21_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.logout(); });
...
function NavComponent_mat_toolbar_3_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-toolbar", 1);
...
NavComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NavComponent, selectors: [["app-nav"]], decls: 5, vars: 8, consts: [["color", "primary", 4, "ngIf"], ["color", "primary"], ["mat-icon-button", "", "routerLink", "/main/home"], ["mat-icon-button", "", 3, "matMenuTriggerFor"], ["menu", "matMenu"], ["mat-menu-item", "", "routerLink", "/main/home"], ["mat-menu-item", "", "routerLink", "/main/pessoas"], ["fxFlex", ""], ["mat-icon-button", "", 3, "click"], ["xPosition", "before", 1, "before", 3, "overlapTrigger"], ["profileMenu", "matMenu"], [1, "username"], ["mat-menu-item", ""], ["mat-button", "", "routerLink", "/auth/login"], ["mat-button", "", "routerLink", "/auth/register"]], template: function NavComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! D:\shop-app\shop-app\src\main.ts */"./src/main.ts");
